...
class ParticleEngine:
	...
	def __init__(self, model, nb=600, ray=20.0, move = False):
		...
		self.generatorNode.setTexture(loader.loadTexture(shimConfig.getInstance().getConvRessourceDirectory() + "images/particle/stardust.png"))
...
class AriTrail:
	def __init__(self, np, nb = 20, delay = 0.03):
		...
		self.generatorNode.setTransparency(True)
		self.generatorNode.setTwoSided(True)
		self.generatorNode.setTexture(loader.loadTexture(shimConfig.getInstance().getConvRessourceDirectory() + "img/particles/white.png"))
...
class AriTrail2:
	def __init__(self, np, nb = 20, delay = 0.03):
		...
		self.generatorNode.setTransparency(True)
		self.generatorNode.setTwoSided(True)
		self.generatorNode.setTexture(loader.loadTexture(shimConfig.getInstance().getConvRessourceDirectory() + "images/particle/white_a.png"))
		self.generatorNode.setBin("fixed",0)
		self.generatorNode.setLightOff(True)
