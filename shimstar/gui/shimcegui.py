...
class ShimCEGUI(object): 
	...
	# Tells ShimCEGUI to handle hiding/showing the system cursor on enable/disable 
	...
	@staticmethod
	def getInstance():
		if ShimCEGUI.instance==None:
			ShimCEGUI.instance= ShimCEGUI()
			ShimCEGUI.instance.initializeResources(shimConfig.getInstance().getRessourceDirectory() + "datafiles") 
			
			#~ ShimCEGUI.instance.SchemeManager.create("SleekSpace.scheme") 
			ShimCEGUI.instance.SchemeManager.create("shimstar.scheme") 
			ShimCEGUI.instance.SchemeManager.create("TaharezLook.scheme") 
			#~ ShimCEGUI.instance.System.setDefaultMouseCursor("SleekSpace", "MouseArrow") 
			ShimCEGUI.instance.System.setDefaultMouseCursor("ShimstarImageset", "MouseArrow") 
	...
	def initializeResources(self, resourcePath): 
			...
			rp.setResourceGroupDirectory("animations", resourcePath + "\\animations") 
			
			# Set default resource groups 
			PyCEGUI.Imageset.setDefaultResourceGroup("imagesets") 
			#~ PyCEGUI.Imageset.setDefaultResourceGroup("images") 
	...
	def enableInputKeyboardHandling(self):
	...
	def disableInputKeyboardHandling(self):
			for key, keyTuple in self.keys.iteritems(): 
					base.ignore(key) 
					base.ignore(key + '-up') 
