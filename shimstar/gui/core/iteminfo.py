...
# InfoItem/Energie
    ...
    def showWeapon(self):
        ...
        self.CEGUI.WindowManager.getWindow("InfoItem/Info2").setText(
            "Frequence de tir : " + str(self.obj.getFrequency()) + " tir / sec")
    ...
    def showContainer(self):
        ...
        self.CEGUI.WindowManager.getWindow("InfoItem/Encombrement").setText(
            "Espace supplementaire : " + str(self.obj.getSpace()))

    def showEngine(self):
        self.CEGUI.WindowManager.getWindow("InfoItem/Info1").setText("Acceleration : " + str(self.obj.getAcceleration()))
        self.CEGUI.WindowManager.getWindow("InfoItem/Info2").setText("vitesse : " + str(self.obj.getSpeedMax()) )
        self.CEGUI.WindowManager.getWindow("InfoItem/Info1").show()
        self.CEGUI.WindowManager.getWindow("InfoItem/Info2").show()
